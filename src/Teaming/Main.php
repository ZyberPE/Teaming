    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool{
        ...
        switch(strtolower($args[0])){
            ...
            case "create":
                ...
                $result = $this->teamManager->createTeam(
                    $sender,
                    $args[1]
                );
            ...
            case "invite":
                ...
                $result = $this->teamManager->invite(
                    $sender,
                    $target
                );
